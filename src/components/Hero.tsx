  ...
  return (
    <section className="min-h-screen pt-20 overflow-hidden">
      <div className="w-full px-[6%]">
        <div className="max-w-[1100px] mx-auto flex flex-col lg:flex-row items-center justify-between min-h-[calc(100vh-5rem)] gap-12">
          {/* Left Content */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            ...
            <motion.div
              ...
              className="space-y-6 text-[17px] text-gray-300 leading-relaxed mb-12 text-justify"
            >
          ...
          <motion.div
            ...
            className="w-full lg:w-[460px] lg:flex-shrink-0 perspective"
          >
            <motion.div
