    ...
    <section id="skills" className="min-h-screen py-24 relative overflow-hidden" ref={ref}>
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          ...
          className="absolute w-[800px] h-[800px] -top-96 -right-96 bg-[#c9b694]/10 rounded-full blur-[120px]"
        />
        <motion.div
          animate={{
            scale: [1, 1.1, 1],
      ...
      <div className="w-full px-8 xl:px-12 relative z-10">
        ...
        >
          <motion.h1 
            className="text-4xl lg:text-5xl font-bold text-[#c9b694] mb-4"
            initial={{ opacity: 0, y: -20 }}
            animate={inView ? { opacity: 1, y: 0 } : { opacity: 0, y: -20 }}
          ...
          >
            Welcome to my tech toolkit! While my expertise lies in Data Engineering, I've explored each of these technologies at some point & have thoroughly enjoyed creating with them. Sure, I won't claim to be a guru in everything (let's keep it real!), but <span className="text-[#c9b694] font-medium">here's my secret sauce</span>: Once you truly get what a tool is meant for and why you'd use it, figuring out how is just a matter of resourceful problem-solving! Besides, in tech, knowing how to find the right answers is often more valuable than memorizing them all!
          </motion.p>
        </motion.div>
          ...
          >
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {skills.map((skill, index) => (
                ...
                >
                  <motion.div
                    className="bg-[#F0F4F8] bg-opacity-5 backdrop-blur-sm rounded-xl p-4 h-full flex items-center justify-center text-center transition-all duration-300 hover:bg-opacity-10 border border-white/5 hover:border-[#c9b694]/30 shadow-lg hover:shadow-[#c9b694]/5 relative overflow-hidden"
                    animate={{
                  ...
                  >
                    ...
                    <span className="text-gray-300 group-hover:text-[#c9b694] transition-colors duration-300 font-medium relative z-10">
                      {skill}
                    </span>
                  </motion.div>
                </motion.div>
          ...
          <div className="lg:w-1/4 space-y-6">
            ...
            >
              <motion.div
                ...
                className="absolute inset-0 bg-gradient-to-r from-[#c9b694]/10 to-purple-500/10"
              />
              <motion.div
              ...
              >
                ...
                <motion.div
                  className="text-3xl font-bold text-[#c9b694] mb-2"
            ...
            >
              <motion.h3
                className="text-lg font-bold text-[#c9b694] mb-4 text-center"
